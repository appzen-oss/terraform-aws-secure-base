...
locals {
  ...
  s3_bucket_arns = [
    one(module.s3_bucket-eu-west-1.*.s3_bucket_arn),
    one(module.s3_bucket-us-east-1.*.s3_bucket_arn),
    one(module.s3_bucket-us-east-2.*.s3_bucket_arn)
  ]
  s3_bucket_names = [
    one(module.s3_bucket-eu-west-1.*.s3_bucket_name),
    one(module.s3_bucket-us-east-1.*.s3_bucket_name),
    one(module.s3_bucket-us-east-2.*.s3_bucket_name)
  ]
